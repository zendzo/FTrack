          ...
          <table class="table table-hover" id="basic-data-table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a href="{{ route('admin.purchases.show',$sale->id) }}">{{ $sale->code }}</a></td>
                <td>{{$sale->purchase_date->format('d/m/y H:i')}}</td>
                <td>{{$sale->sent_date->format('d/m/y H:i')}}</td>
                <td>{{Str::limit($sale->address)}}</td>
                <td>
                  <ul>
                    ...
                    <li>
                      ...
                      {{ $product->unit->name }}) <b>Rp.
                        {{ number_format($product->pivot->grand_total,2,',','.') }} (jasa Rp. {{number_format($product->pivot->delivery_fee,2,',','.')}})</b>
                    </li>
                    @php
                  ...
                  <b>Grand Total + Jasa {{ $sale->margin->margin }} % : Rp.

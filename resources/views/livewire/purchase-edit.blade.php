                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('purchase_date') is-invalid @enderror"
                                    wire:model="purchase_date" autocomplete="off" id="purchase_date_edit"
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control dateRange @error('sent_date') is-invalid @enderror"
                                    wire:model="sent_date" autocomplete="off" id="sent_date_edit"
                                    onchange="this.dispatchEvent(new InputEvent('input'))">
                                @error('sent_date')
                                <div class="invalid-feedback">
                                    {{ $message }}
